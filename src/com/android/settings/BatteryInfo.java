    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                //TODO: revert back to original code once status in bq27200 is fixed
                ...
                switch (plugType) {
                    case 0:
                        ...
                        mStatus.setText(getString(R.string.battery_info_status_discharging));
                        break;
                    case BatteryManager.BATTERY_PLUGGED_AC:
                        mPower.setText(getString(R.string.battery_info_power_ac));
                        mStatus.setText(getString(R.string.battery_info_status_charging));
                        break;
